...
public class TestPlayoffs {
	...
	public static void main(String[] args) {
		...
		st = pl.getStandings();
		if (st[2].getTeamA().equals("Maple Leafs") && st[2].getTeamB().equals("Canadiens") && st[2].getTeamAWins() == 3
				&& st[2].getTeamBWins() == 4) {
		...
		if (st[6].getTeamA().equals("Hurricanes") && st[6].getTeamB().equals("Predators") && st[6].getTeamAWins() == 4
				&& st[6].getTeamBWins() == 2) {
		...
		if (st[9].getTeamA().equals("Canadiens") && st[9].getTeamB().equals("Jets") && st[9].getTeamAWins() == 4
				&& st[9].getTeamBWins() == 0) {
		...
		String res = pl.updateStandings("Golden Knights", "Canadiens", 1, 0); // Giving an extra win to the Golden
																				// Knights.
